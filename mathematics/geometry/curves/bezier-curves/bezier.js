...
class LinearBezier extends Bezier {
  ...
  static createFromPoints(points) {
    ...
    const p0 = points[0];
    const p1 = points[1];
    const linear_bezier_points = create_range(0, 1, 0.01).reduce(
      (points, t) => {
...
class QuadraticBezier extends Bezier {
  ...
  static createFromPoints(points) {
    ...
    const p1 = points[1];
    const p2 = points[2];
    const quadratic_bezier_points = create_range(0, 1, 0.01).reduce(
      (points, t) => {
...
class QuarticBezier extends Bezier {
  ...
  static createFromPoints(points) {
    ...
    const quartic_bezier_points = create_range(0, 1, 0.01).reduce(
      (points, t) => {
